...
authors: 'Hao Zhang^, Jeffrey Xu Yu, Yikai Zhang, Kangfei Zhao, Hong Cheng'
abstract: 'Develops a general distributed approach to local subgraph counting, supporting broader pattern classes through relational-algebra-based execution.'
date: 2020-10-01
venue: '46th International Conference on Very Large Data Bases (VLDB)'
paperurl: 'http://www.vldb.org/pvldb/vol13/p2493-zhang.pdf'
selected: true
research_theme: 'Graph & Distributed Analytics'
citation:
---
