...
abstract: 'Introduces a MapReduce triangle-listing method for billion-scale graphs that sharply reduces shuffle traffic and improves distributed scalability.'
date: 2016-10-01
venue: 'IEEE International Conference on Big Data (BigData)'
paperurl: 'https://scholar.google.com/scholar?q=Efficient+triangle+listing+for+billion-scale+graphs'
