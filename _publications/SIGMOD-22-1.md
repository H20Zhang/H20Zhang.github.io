...
authors: 'Hao Zhang^, Jeffrey Xu Yu, Yikai Zhang, Kangfei Zhao'
abstract: 'Introduces Secco, a parallel query processing approach that explicitly separates communication from computation to widen the optimization space.'
date: 2022-06-12
venue: 'ACM SIGMOD/PODS International Conference on Management of Data (SIGMOD)'
paperurl: 'https://scholar.google.com/scholar?q=Parallel+Query+Processing%3A+To+Separate+Communication+from+Computation'
selected: true
research_theme: 'Distributed Query Processing'
citation:
---
