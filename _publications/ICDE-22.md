...
authors: 'Hao Zhang^, Qiyan Li, Kangfei Zhao, Jeffrey Xu Yu, Yuanyuan Zhu'
abstract: 'Demonstrates how learned estimation can improve cyclic join decomposition for subgraph matching through the LSSMatch prototype.'
date: 2022-10-01
venue: '38th IEEE International Conference on Data Engineering (ICDE) (Demo)'
paperurl: 'https://scholar.google.com/scholar?q=How+Learning+Can+Help+Complex+Cyclic+Join+Decomposition'
research_theme: 'AI for Data Management'
citation:
---
